...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "F48D2"  # Playfab Title Id
        self.SecretKey: str = "714FKCZXIP5TC6JPJHHZ8ESTU36CIFPODYB9DXZ4PFITCCYOKS"  # Playfab Secret Key
        self.ApiKey: str = "OC|1183250974865885|2b95de4d4c72424b14ceef8988a745da"  # App Api Key (Oculus/Graph API)
...
def titledata():
    response_data = {
        ...
        "SeasonalStoreBoardSign": "<color=pink>RATE THE GAME 5 STARS!</color>\n<color=pink>.gg/zuaxuDGpYK</color>",
        # Text and Messages
        "EmptyFlashbackText": "FLOOR TWO NOW OPEN\n FOR BUSINESS\n\nSTILL SEARCHING FOR\nBOX LABELED 2021",
        "MOTD": "<color=#EB0909>WELCOME TO BACK TAG!</color>\n\n<color=#EB0909>CURRENT UPDATE: I LAVA YOU 2024</color>\n<color=#EB0909>BOOST THE DISCORD FOR ALL COSMETICS</color>\n<color=#EB0909>HARMONY IS SIGMA</color>\n<color=#0911EB>OWNERS ARE : ZENON : HARMONY :</color>\n<color=#0911EB>SIGMA SIGMA SIGMA BOY</color>\n\n<color=#0911EB>discord.gg/zuaxuDGpYK</color>",
        "TOBAlreadyOwnCompTxt": "discord.gg/zuaxuDGpYK",
        "TOBAlreadyOwnPurchaseBundle": "BACK TAG",
        "TOBDefCompTxt": "discord.gg/zuaxuDGpYK",
        "TOBDefPurchaseBtnDefTxt": "BACK TAG",
        # Legal and Versions
        "EnableCustomAuthentication": True,
        "LatestPrivacyPolicyVersion": "2024.09.20",
        "LatestTOSVersion": "2024.09.20",
        "TOS_2024.09.20": "discord.gg/zuaxuDGpYK",
